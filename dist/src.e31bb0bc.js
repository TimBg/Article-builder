...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/main_photo.png":[function(require,module,exports) {
module.exports = "/main_photo.69156156.png";
...
var _main_photo = _interopRequireDefault(require("./assets/main_photo.png"));

var _blocks = require("./classes/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('Article builder', {
  tag: 'h1',
  styles: {
...
}), new _blocks.ImageBlock(_main_photo.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
  ...
  alt: 'image'
}), new _blocks.ColumnsBlock(['Create your article', ''], {
  styles: {
    background: 'linear-gradient(to right, white, grey)',
    padding: '2rem',
    color: '#',
...
}), new _blocks.TextBlock('With your own styles', {
  styles: {
    background: 'linear-gradient(to right, white, grey)',
    padding: '2rem',
    'font-weight': 'bold'
...
exports.model = model;
},{"./assets/main_photo.png":"assets/main_photo.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
...
},{"./model":"model.js","./classes/app":"classes/app.js","./styles/index.css":"styles/index.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
